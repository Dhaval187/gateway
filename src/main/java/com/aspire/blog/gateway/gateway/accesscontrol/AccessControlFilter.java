package com.aspire.blog.gateway.gateway.accesscontrol;
...
public class AccessControlFilter extends ZuulFilter {
	...
	public boolean shouldFilter() {
		...
		// If the request Uri does not start with the path of the authorized endpoints,
	...
	private boolean isAuthorizedRequest(String serviceUrl, String serviceName, String requestUri) {
		...
		// If the authorized endpoints list was left empty for this route, all access
		// are allowed
