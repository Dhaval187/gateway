...
import com.aspire.blog.gateway.repository.AuthorityRepository;
import com.aspire.blog.gateway.repository.UserRepository;
import com.aspire.blog.gateway.security.AuthoritiesConstants;
import com.aspire.blog.gateway.service.MailService;
import com.aspire.blog.gateway.service.UserService;
import com.aspire.blog.gateway.service.dto.PasswordChangeDTO;
import com.aspire.blog.gateway.service.dto.UserDTO;
import com.aspire.blog.gateway.web.rest.errors.ExceptionTranslator;
import com.aspire.blog.gateway.web.rest.vm.KeyAndPasswordVM;
import com.aspire.blog.gateway.web.rest.vm.ManagedUserVM;
...
public class AccountResourceIT {
	...
	public void testGetUnknownAccount() throws Exception {
		...
		restUserMockMvc.perform(get("/api/account").accept(MediaType.APPLICATION_PROBLEM_JSON))
	...
	public void testRegisterDuplicateEmail() throws Exception {
		...
		restMvc.perform(post("/api/register").contentType(TestUtil.APPLICATION_JSON_UTF8)
				.content(TestUtil.convertObjectToJsonBytes(userWithUpperCaseEmail))).andExpect(status().isCreated());
	...
	public void testChangePasswordWrongExistingPassword() throws Exception {
		...
		restMvc.perform(post("/api/account/change-password").contentType(TestUtil.APPLICATION_JSON_UTF8).content(
				TestUtil.convertObjectToJsonBytes(new PasswordChangeDTO("1" + currentPassword, "new password"))))
	...
	public void testRequestPasswordReset() throws Exception {
		...
		restMvc.perform(post("/api/account/reset-password/init").content("password-reset@example.com"))
				.andExpect(status().isOk());
	}
	...
	public void testRequestPasswordResetWrongEmail() throws Exception {
		restMvc.perform(post("/api/account/reset-password/init").content("password-reset-wrong-email@example.com"))
				.andExpect(status().isBadRequest());
	}
	...
	public void testFinishPasswordReset() throws Exception {
		...
		restMvc.perform(post("/api/account/reset-password/finish").contentType(TestUtil.APPLICATION_JSON_UTF8)
				.content(TestUtil.convertObjectToJsonBytes(keyAndPassword))).andExpect(status().isOk());
	...
	public void testFinishPasswordResetTooSmall() throws Exception {
		...
		restMvc.perform(post("/api/account/reset-password/finish").contentType(TestUtil.APPLICATION_JSON_UTF8)
				.content(TestUtil.convertObjectToJsonBytes(keyAndPassword))).andExpect(status().isBadRequest());
